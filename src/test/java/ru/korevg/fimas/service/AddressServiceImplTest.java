...
class AddressServiceImplTest {
    ...
    void createDynamic_firewallNotFound_throws() {
        var request = new AddressDynamicCreateRequest("Dyn1", null, Set.of("8.8.8.8"), 999L);
    ...
    void createDynamic_success() {
        var request = new AddressDynamicCreateRequest(
                "GoogleDNS", "DNS Google", Set.of("8.8.8.8", "8.8.4.4"), 5L
        );
